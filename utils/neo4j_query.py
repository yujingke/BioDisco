...
if __name__=="__main__":
    # Test KG subgraph retrieval
    graph = Neo4jGraph("bolt://localhost:7687","neo4j","1234567890")
    print(graph.get_subgraph(["kidney cancer","ARISTOLOCHIC ACID"], domain="disease"))
    graph.close()
